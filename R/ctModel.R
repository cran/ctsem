...
#' 
#' @param TIPREDVAR lower triangular n.TIpred * n.TIpred Cholesky decomposed covariance
...
#' 
#' @param timeVarying character vector of matrices to allow to vary over measurement occasions. Currently only accepts 'MANIFESTMEANS'. 
#' @examples 
#' 
